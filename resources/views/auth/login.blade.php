...
<body
    class="min-h-screen font-sans antialiased text-slate-800 flex flex-col justify-start py-8 sm:py-12 px-3.5 sm:px-6 lg:px-8 bg-gradient-to-br from-slate-950 via-slate-900 to-emerald-950">

    <div class="sm:mx-auto sm:w-full sm:max-w-md text-center px-2">
        <div class="inline-flex items-center justify-center mb-3">
            <img src="{{ asset('images/logo-veterinar.png') }}" alt="Logo Jabatan Perkhidmatan Veterinar"
                class="w-16 h-16 sm:w-20 sm:h-20 object-contain drop-shadow-2xl bg-white/95 p-2 rounded-2xl border border-slate-700/40">
        </div>
    ...
    <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-xl px-4">
        <div class="bg-white py-8 px-6 shadow-2xl rounded-3xl sm:px-10 border border-slate-100">
            ...
            @if(session('success'))
                <div
                    class="mb-5 p-4 rounded-xl bg-emerald-50 border border-emerald-200 text-emerald-800 text-sm font-medium flex items-center gap-2.5">
            ...
            @if($errors->any())
                <div class="mb-5 p-4 rounded-xl bg-rose-50 border border-rose-200 text-rose-800 text-xs font-medium">
                    <div class="font-bold mb-1 flex items-center gap-1.5"><i class="fa-solid fa-triangle-exclamation"></i>
                        Ralat Log Masuk:</div>
            ...
            <form action="{{ route('login') }}" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input id="ic_number" name="ic_number" type="text" autocomplete="username" required value="{{ old('ic_number') }}" placeholder="Contoh: 800730035114 atau emel" class="w-full pl-10 pr-4 py-2.5 text-sm bg-slate-50 border border-slate-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-emerald-500 focus:outline-none transition font-mono">
                    </div>
                    <p class="text-[11px] text-slate-400 mt-1">Masukkan 12 digit tanpa tanda sempang (-) atau alamat
                        emel berdaftar.</p>
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input id="password" name="password" type="password" required
                            ...
                            class="w-full pl-10 pr-4 py-2.5 text-sm bg-slate-50 border border-slate-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-emerald-500 focus:outline-none transition">
                    </div>
                </div>
                ...
                <button type="submit"
                    class="w-full py-3 px-4 bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-sm rounded-xl shadow-lg shadow-emerald-700/30 transition duration-150 flex items-center justify-center gap-2">
