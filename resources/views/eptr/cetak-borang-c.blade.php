...
<head>
    <meta charset="UTF-8">
    <title>BORANG C - PEMBATALAN PENDAFTARAN TERNAKAN RUMINAN</title>
    ...
    <style>
        ...
        @media print {
            ...
            .form-container { width: 100% !important; max-width: 210mm !important; box-shadow: none !important; border: none !important; padding: 10mm 15mm !important; margin: 0 auto !important; }
        }
    </style>
</head>
<body class="p-4 sm:p-8 flex flex-col items-center">
    ...
    <div class="no-print mb-6 flex flex-wrap gap-3">
        <button onclick="window.print()" class="px-6 py-2.5 bg-rose-700 hover:bg-rose-800 text-white font-bold text-sm rounded-xl shadow-lg transition flex items-center gap-2">
            <i class="fa-solid fa-print"></i>
            <span>Cetak Borang C (Format Asal)</span>
        </button>
        <a href="{{ route('eptr.borang-c.index') }}" class="px-4 py-2.5 bg-white border border-slate-300 hover:bg-slate-50 text-slate-700 font-bold text-sm rounded-xl transition">
            Kembali ke Senarai Borang C
        </a>
    </div>

    <!-- Official Borang C Sheet (Exact Document Format) -->
    <div class="form-container max-w-[210mm] w-full bg-white p-10 sm:p-12 shadow-2xl text-black">
