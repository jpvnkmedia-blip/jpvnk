...
<head>
    <meta charset="UTF-8">
    <title>BORANG A - DAFTAR TERNAKAN RUMINAN ({{ $ternakan->no_tag }})</title>
...
<body class="p-4 sm:p-8 flex flex-col items-center">
    ...
    <div class="no-print mb-6 flex flex-wrap gap-3">
        <button onclick="window.print()" class="px-6 py-2.5 bg-slate-900 hover:bg-slate-800 text-white font-bold text-sm rounded-xl shadow-lg transition flex items-center gap-2">
            ...
            <span>Cetak Borang A (Format Asal)</span>
        </button>
    ...
    <!-- Official Borang A Sheet (Exact Document Format) -->
    <div class="form-container max-w-[210mm] w-full bg-white p-10 sm:p-12 shadow-2xl text-black">
        ...
        <div class="text-[9pt] text-slate-500 flex justify-between items-center pt-2">
            <div>Tarikh Cetakan: {{ date('d/m/Y H:i:s') }}</div>
            <div class="font-mono">JPVNK-EPTR-BORANG-A</div>
        </div>
